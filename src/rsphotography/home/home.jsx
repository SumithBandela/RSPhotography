    ...
    <div>
      <div className="container-fluid p-4">
        ...
        <div className="hero-section row align-items-center mb-5">
          <div className="col-md-6 col-sm-12">
            ...
            <p className="text-muted fs-5 mt-4">Where Moments Become Memories</p>
      ...
      <footer className="text-center py-3 mt-5 bg-dark text-white">
        ...
        <div className="social-icons">
          ...
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="bi bi-instagram text-white mx-2 fs-3"></a>
          <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" className="bi bi-youtube text-danger mx-2 fs-3"></a>
        </div>
